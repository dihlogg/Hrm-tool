...
const FooterComponent = () => (
  <Layout.Footer className="py-2 px-4 text-center text-gray-500 bg-gray-50 md:p-4">
    <div className="flex flex-col items-center justify-between gap-1 md:flex-row md:px-4">
      <div className="text-xs md:text-sm">
        <span className="font-semibold text-orange-500">v1.0.0</span> © 2025 NextJS Tailwind
      </div>
      <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-xs md:text-sm">
