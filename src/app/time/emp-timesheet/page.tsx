...
const columns = [
  {
    title: <span className="text-sm font-semibold text-gray-600">Employee Name</span>,
    dataIndex: "name",
    render: (text: string) => (
  ...
  {
    title: <span className="text-sm font-semibold text-gray-600">Timesheet Period</span>,
    dataIndex: "period",
