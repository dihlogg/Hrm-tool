...
import { useUpdateSkill } from "@/hooks/ats/skills/useUpdateSkill";
import { useGetSkillById } from "@/hooks/ats/skills/useGetSkillById";
...
export default function EditSkillPage() {
  ...
  const { skill } = useGetSkillById(skillId ?? "");
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      api.success({
        ...
        description: `The skill has been updated in the dictionary.`,
