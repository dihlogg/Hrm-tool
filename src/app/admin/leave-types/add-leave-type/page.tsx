...
import { useAddLeaveType } from "@/hooks/leave/leave-types/useAddLeaveType";
import { LeaveTypeDto } from "@/hooks/leave/leave-types/LeaveTypeDto";

export default function AddLeaveTypePage() {
  const { addLeaveType } = useAddLeaveType();
  ...
  const [expireMonth, setExpireMonth] = useState<number>(3); // Default March
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      api.success({
        ...
        description: `Leave Type ${name} has been added.`,
