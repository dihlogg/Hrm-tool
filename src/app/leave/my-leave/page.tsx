...
const columns = [
  {
    title: <span className="text-sm font-semibold text-gray-600">No</span>,
    dataIndex: "No",
    render: (text: string) => (
  ...
  {
    title: (
      <span className="text-sm font-semibold text-gray-600">Time Request</span>
    ),
  ...
  {
    title: (
      <span className="text-sm font-semibold text-gray-600">Approver</span>
    ),
    dataIndex: "Approver",
    render: (text: string) => (
      <span className="text-sm text-gray-500 font-small">{text}</span>
  ...
  {
    title: (
      <span className="text-sm font-semibold text-gray-600">Delegate To</span>
    ),
